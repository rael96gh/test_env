...
class SaturationMutagenesis(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            generation_mode = data.get('generation_mode', 'individual')
            ...
            print(f'🔥 BACKEND - include_original: {include_original}')
            print(f'🔥 BACKEND - generation_mode: {generation_mode}')
            ...
            result = generate_saturation_mutagenesis(sequences, parsed_mutations, exclude_stops, generation_mode)

            if include_original:
                result.insert(0, fasta_content)
...
class ScanningLibrary(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            sequence = first_sequence.get('seq', '')
            sequence_name = first_sequence.get('name', 'sequence')
