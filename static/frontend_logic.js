...
async function generateOligos() {
    ...
    try {
        const response = await fetch('/api/generate_oligos', {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            if (fragments.length > 0) {
                ...
                for (const fr of fragments) {
                    const primerResponse = await fetch('/api/generate_primers', {
                        method: 'POST',
...
async function downloadOligoList() {
    ...
    try {
        const response = await fetch('/api/download_oligos_csv', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function downloadPrimers() {
    ...
    try {
        const response = await fetch('/api/download_primers_csv', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function downloadPoolingAndDilutionFiles() {
    ...
    try {
        const response = await fetch('/api/download_pooling_dilution_files', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function generateCustomSequences() {
    ...
    try {
        const response = await fetch('/api/custom_mutagenesis', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function generateSaturationLibrary() {
    ...
    try {
        const response = await fetch('/api/saturation_mutagenesis', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
async function transformToScanningLibrary() {
    ...
    try {
        const response = await fetch('/api/scanning_library', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                sequence: sequenceInput,
